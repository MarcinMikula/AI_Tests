...
def get_unassigned_defects():
    # JQL: Defekty bez przypisania
    jql = 'assignee is EMPTY AND issuetype = "Bug"'
    start_at = 0
...
if __name__ == "__main__":
    unassigned_defects = get_unassigned_defects()
    save_to_file(unassigned_defects, "unassigned_defects.json")